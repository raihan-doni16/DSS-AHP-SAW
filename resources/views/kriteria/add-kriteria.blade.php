    ...
    <div class="px-6 py-4">
        ...
        <form action="{{route('kriteria.post')}}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama_kriteria" name="nama_kriteria" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            <div class="mb-4">
